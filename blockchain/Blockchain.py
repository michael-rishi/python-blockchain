...
version         : 0.5
usage           : execute this file in Jupyter
...
References      : [1] https://github.com/dvf/blockchain/blob/master/blockchain.py
                  ...
                  [3] https://github.com/adilmoujahid/blockchain-python-tutorial
'''
...
# In[2]:
# get_ipython().system('{sys.executable} -m pip install Crypto')
...
# get_ipython().system('{sys.executable} -m pip install flask_cors')
